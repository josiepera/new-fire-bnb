...
CREATE TABLE IF NOT EXISTS listings (
	...
	space VARCHAR(10000) NOT NULL,
	guest_access VARCHAR(10000) NOT NULL,
	interaction VARCHAR(10000) NOT NULL,
	other VARCHAR(10000) NOT NULL,
	contact_host VARCHAR(10000) NOT NULL,
	amenities_one VARCHAR(10000) NOT NULL,
	amenities_two VARCHAR(10000) NOT NULL,
	amenities_three VARCHAR(10000) NOT NULL,
	amenities_four VARCHAR(10000) NOT NULL,
